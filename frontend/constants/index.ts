...
import sad from "@/assets/images/relax.png";
...
export const dummyJournalEntries = [
  {
    ...
    entry:
      "Woke up early today and enjoyed the sunrise. I'm feeling optimistic about the project deadline I've been worried about. The team seems to be making good progress.",
  ...
  },
  {
    ...
    entry:
      "Too many meetings today. Barely had time to work on actual tasks. I need to find a better way to manage my calendar and protect my focus time. Maybe I should start blocking out time for deep work.",
  ...
  },
  {
    ...
    entry:
      "Had a good conversation with my sister today. We haven't spoken in a while and it was nice to catch up. Reminded me that I should make more time for family despite how busy work gets.",
  ...
  },
  {
    ...
    entry:
      "Finally solved that bug I've been stuck on for days! Sometimes the solution is simpler than you think. I need to remember to take a step back when I get stuck in the details.",
  ...
  },
  {
    ...
    title: "Missing Home",
    entry:
      "Been thinking about my hometown today. It's been over a year since I visited. The pandemic really changed everything. Hope I can plan a trip back soon to see old friends and family.",
  ...
  },
  {
    ...
    entry:
      "Nothing particularly special today. Work was work. Made dinner, watched some TV. Sometimes ordinary days are nice too.",
  ...
  },
  {
    ...
    entry:
      "The UI for the journal feature is coming along nicely. Still need to implement the mood tracking system and connect everything to the backend. Estimated completion in about a week if everything goes smoothly. Need to test different entry lengths to make sure the layout handles them well. This is an intentionally longer entry to test how the UI handles multiple paragraphs and extended content that might cause scrolling or text overflow issues in the card layout.",
  ...
  },
  {
    ...
    title: "Health Goals",
    entry:
      "Started a new workout routine today. Feeling sore but good. Need to be more consistent with exercise.",
  ...
  },
  {
    ...
    entry:
      "Can't sleep. Worried about the presentation tomorrow. What if I forget important points? What if they ask questions I can't answer? I should have prepared more.",
  ...
  },
  {
    ...
    title: "Weekend Plans",
    entry:
      "Looking forward to hiking this weekend. The weather forecast looks perfect, and I need some time in nature after being cooped up all week.",
